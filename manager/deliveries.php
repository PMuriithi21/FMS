...
$stmt = $db->prepare("SELECT d.*, f.fuel_name, u.name as logged_by FROM deliveries d JOIN fuel_types f ON d.fuel_id=f.fuel_id JOIN users u ON d.user_id=u.user_id WHERE YEAR(d.delivery_date)=? AND MONTH(d.delivery_date)=? ORDER BY d.delivery_date DESC");
...
<div class="card">
    ...
    <div class="stats-grid" style="margin-bottom:24px;">
        <div style="text-align:center;">
            <div class="stat-bubble navy">
                ...
                <span class="stat-value"><?= count($deliveries) ?></span>
    ...
    <div class="table-wrap">
        <table>
            <thead>
                <tr><th>Date</th><th>Fuel</th><th>Volume (L)</th><th>Supplier</th><th>Logged By</th><th>Notes</th></tr>
            </thead>
            <tbody>
                <?php if (empty($deliveries)): ?>
                <tr><td colspan="6" style="text-align:center;color:var(--text-light);padding:20px;">No deliveries found for <?= clean($month) ?>.</td></tr>
                <?php endif; ?>
